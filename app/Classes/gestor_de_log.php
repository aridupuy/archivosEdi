...
//            $ulog->set_id_marchand('1');
//            $ulog->set_id_usumarchand('1');
//            $ulog->set_id_authcode(Authcode::USUARIO_INTERNO);
//        }
//        if (Application::$usuario AND get_class(Application::$usuario) == 'Usumarchand') {
//            $ulog->set_id_marchand(Application::$usuario->get_id_marchand());
//            $ulog->set_id_usumarchand(Application::$usuario->get_id());
//            $ulog->set_id_auth('0');
//            $ulog->set_id_authcode(Authcode::USUARIO_EXTERNO);
//        }
