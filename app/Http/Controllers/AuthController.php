...
//        var_dump($usuario);
        if($usuario->getId()==null or $usuario->get_id_authstat()!= \Authstat::ACTIVO){
...
//        developer_log(json_encode($variables));
    ...
    public function changePassword(Request $request){
        ...
        $usuario->set_password(isset($variables["password"])? $variables["password"]: $variables["clave"]);
        dd([$pass, $usuario->get_password()]);
        if($usuario->set()){
